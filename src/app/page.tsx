  ...
  return (
    <div className="flex flex-col gap-0 pb-24 animate-fade-in overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-4 pt-32 md:pt-20">
        ...
        <div className="absolute top-0 -z-10 w-full h-full bg-[#080d18]" />
        <div className="absolute top-1/4 -left-1/4 -z-10 w-[500px] h-[500px] bg-[#6836e8]/8 rounded-full blur-[120px] opacity-60 pointer-events-none" />
        <div className="absolute bottom-1/3 -right-1/4 -z-10 w-[500px] h-[500px] bg-[#283264]/12 rounded-full blur-[120px] opacity-50 pointer-events-none" />
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto animate-fade-in-up delay-200">
          <Link 
            href="/dashboard"
            className="group relative px-8 py-4 bg-[#6836e8] hover:bg-[#7a45f5] text-white font-black rounded-xl transition-all flex items-center justify-center gap-3 overflow-hidden shadow-[0_0_30px_rgba(104,54,232,0.30)]"
          >
          ...
          <a 
            href="#how-it-works" 
            className="px-8 py-4 bg-[#0c1424]/90 hover:bg-[#0f1a2e] text-white font-bold rounded-xl border border-[#283264]/35 transition-all flex items-center justify-center backdrop-blur-xl"
          >
      ...
      <section className="w-full bg-gradient-to-b from-[#080d18]/80 via-[#060b14] to-[#080d18]/80 py-24 border-y border-[#162040]/30 relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[300px] bg-[#6836e8]/4 rounded-full blur-[150px] pointer-events-none" />
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="space-y-3 pt-2">
              {[
                ...
                <div key={i} className="flex items-center gap-3 text-xs sm:text-sm text-gray-300 font-bold bg-[#0c1424]/80 p-3 rounded-xl border border-[#1e2e50]/30">
                  <ShieldCheck className="w-4 h-4 text-[#8b6af0] shrink-0" />
                  <span>{point}</span>
                </div>
              ))}
            </div>
          ...
          <div className="lg:col-span-6 flex justify-center">
            <div className="w-full max-w-lg glass-panel p-6 sm:p-8 rounded-3xl border border-violet-500/20 shadow-[0_0_50px_rgba(124,58,237,0.1)] relative overflow-hidden backdrop-blur-xl">
              ...
              <div className="mt-6 space-y-3">
                ...
                <div className="p-4 rounded-2xl bg-[#080d18] border border-[#1e2e50]/40 relative overflow-hidden group">
              ...
              <div className="py-4 flex flex-col items-center justify-center relative">
                ...
                <div className="absolute bg-[#080d18] border border-[#1e2e50]/50 px-3 py-1 rounded-full text-[9px] font-mono text-[#8b6af0] font-bold tracking-widest shadow-lg uppercase">
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 rounded-2xl bg-gradient-to-r from-[#6836e8]/8 to-[#080d18] border border-[#6836e8]/20 relative overflow-hidden">
              ...
              <div className="mt-6 pt-4 border-t border-[#162040]/35 flex items-center justify-between bg-[#0c1424]/60 p-3 rounded-xl">
      ...
      <section className="pt-24 flex flex-col items-center text-center px-4">
        ...
        <Link 
          href="/dashboard" 
          className="px-8 py-4 bg-[#6836e8] hover:bg-[#7a45f5] text-white font-black rounded-xl transition-all shadow-[0_0_28px_rgba(104,54,232,0.25)] text-sm tracking-wide"
        >
      ...
      <footer className="w-full max-w-6xl mx-auto mt-32 pt-14 pb-10 border-t border-white/5 px-6 relative z-10">
        {/* Footer glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[150px] bg-gradient-to-r from-[#7042f4]/5 via-[#3b50a0]/8 to-[#7042f4]/5 rounded-full blur-[100px] -z-10 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center justify-between">
          ...
          <div className="md:col-span-7 w-full md:w-auto flex items-center justify-center md:justify-end gap-2 sm:gap-4 text-[11px] sm:text-xs font-bold uppercase tracking-wider mt-4 md:mt-0">
            <a 
              ...
              className="px-2.5 py-1.5 sm:px-3.5 sm:py-2 rounded-xl bg-[#1a2540]/60 hover:bg-[#7042f4]/10 border border-[#2a3a6a]/40 hover:border-[#7042f4]/40 transition-all duration-300 text-gray-400 hover:text-white flex items-center gap-1 group"
            >
              <span>Twitter</span>
              <ArrowRight className="w-3 h-3 opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all text-[#9b7afa] hidden sm:inline-block shrink-0" />
            </a>
            <a 
