  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in pb-16">
      ...
      <div className="flex flex-col gap-1.5">
        <h1 className="text-xl sm:text-2xl font-black text-white tracking-tight">Auto-Settlement</h1>
      ...
      {!isConnected && (
        <div className="p-6 rounded-3xl bg-violet-600/10 border border-violet-500/20 flex flex-col sm:flex-row items-center justify-between gap-4 animate-fade-in shadow-[0_0_40px_rgba(124,58,237,0.1)]">
          <div className="flex items-center gap-4 text-center sm:text-left">
            ...
            <div>
              <h3 className="text-sm font-black text-white uppercase tracking-tight">Manager Locked</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="glass-panel p-8 rounded-[2.5rem] space-y-8 relative overflow-hidden bg-[#0A0A0F]">
            ...
            <div className="flex items-center justify-between relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-base font-black text-white tracking-tight">Smart Bridge Consolidation</h3>
              ...
              <button 
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-300 focus:outline-none ${
                  isAutoConsolidate ? 'bg-violet-600' : 'bg-white/10'
            ...
            <div className="space-y-6 relative z-10 pt-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-black text-white">{threshold} USDC</span>
                </div>
                <input 
                  type="range" 
                  min="10" 
                  ...
                  disabled={!isConnected}
                  className="w-full h-1.5 bg-white/5 rounded-full appearance-none cursor-pointer accent-violet-500 hover:accent-violet-400 disabled:opacity-30 disabled:cursor-not-allowed"
                />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="glass-panel p-6 rounded-[2rem] border border-white/5 bg-[#0D0D11]">
              <h4 className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-4">Target Destination</h4>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-600 to-indigo-700 flex items-center justify-center text-white shadow-lg">
                  <RefreshCw className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-sm font-black text-white">Arc Network</p>
            ...
            <div className="glass-panel p-6 rounded-[2rem] border border-white/5 bg-[#0D0D11]">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-black text-white">~0.1% / tx</p>
        ...
        <div className="space-y-6">
          <div className="glass-panel p-6 rounded-[2rem] bg-white/[0.01] border border-white/5 space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <div className="w-5 h-5 rounded-full bg-violet-600/20 text-violet-400 text-[10px] font-black flex items-center justify-center shrink-0">1</div>
                <p className="text-[11px] text-gray-400 leading-relaxed">System scans your USDC balances on Base, Arbitrum, and Polygon.</p>
              </div>
              <div className="flex gap-3">
                <div className="w-5 h-5 rounded-full bg-violet-600/20 text-violet-400 text-[10px] font-black flex items-center justify-center shrink-0">2</div>
                <p className="text-[11px] text-gray-400 leading-relaxed">If balance exceeds <span className="text-white font-bold">{threshold} USDC</span>, a cross-chain burn event is triggered.</p>
              </div>
              <div className="flex gap-3">
                <div className="w-5 h-5 rounded-full bg-violet-600/20 text-violet-400 text-[10px] font-black flex items-center justify-center shrink-0">3</div>
                <p className="text-[11px] text-gray-400 leading-relaxed">Tokens are minted directly on Arc Network minus the network fee.</p>
              </div>
            </div>
          </div>

          <div className="glass-panel p-6 rounded-[2rem] bg-gradient-to-br from-violet-600/10 to-transparent border border-violet-500/10">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-[10px] font-black text-white uppercase tracking-widest">System Status</h4>
