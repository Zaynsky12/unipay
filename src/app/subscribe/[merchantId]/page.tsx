  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-[#0A0A0F] relative overflow-hidden animate-fade-in">
      ...
      <div className="absolute top-6 left-6 flex items-center gap-2">
        <div className="w-7 h-7 rounded-xl bg-gradient-to-br from-blue-600 to-violet-600 flex items-center justify-center text-xs font-black text-white shadow-[0_0_15px_rgba(37,99,235,0.3)]">
          U
        </div>
        <span className="text-xs font-black tracking-tight text-white/80">UniPay Subscriptions</span>
      </div>
      ...
      <div className="w-full max-w-md glass-panel p-6 sm:p-8 relative z-10 shadow-2xl space-y-6 rounded-3xl border border-white/5">
        ...
        <div className="text-center space-y-2 pb-4 border-b border-white/5">
          ...
          <p className="text-[11px] text-gray-400 italic">"{merchantMetadata}"</p>
        </div>
        ...
        <div className="space-y-4">
          <div className="p-4 rounded-2xl bg-black/40 border border-white/5 space-y-3">
            ...
            <div className="flex justify-between items-baseline pt-1">
              <span className="text-xs text-gray-400 font-bold">Monthly Charge</span>
            ...
            <div className="pt-2.5 border-t border-white/[0.04] flex justify-between items-center text-xs text-gray-500">
              ...
              <span className="text-gray-300 font-bold">Every {urlInterval} Days</span>
            </div>
          </div>
        </div>
        ...
        {isSuccessState ? (
          <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-center space-y-3 animate-fade-in">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">You will be automatically billed every month. Cancel anytime.</p>
            </div>
          </div>
        ) : (
          /* Kondisi Menunggu */
          <div className="space-y-4">
            {!isConnected ? (
              <div className="space-y-3">
                <div className="p-3.5 bg-blue-600/5 rounded-xl border border-blue-500/10 text-xs text-gray-300 text-center font-medium leading-relaxed">
              ...
              <div className="space-y-4 animate-fade-in">
                ...
                <div className="flex items-center justify-between text-xs p-3 rounded-xl bg-black/40 border border-white/5">
                  ...
                  <span className="font-mono font-bold text-blue-300 bg-white/[0.03] px-2 py-0.5 rounded border border-white/5">
                ...
                {!hasSufficientAllowance ? (
                  ...
                  <button
                    ...
                    className="w-full py-4 rounded-xl flex items-center justify-center gap-2 text-sm font-black text-white bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-500 hover:to-violet-500 shadow-[0_0_30px_rgba(37,99,235,0.3)] transition-all"
                  >
      ...
      <div className="mt-8 text-center text-xs text-gray-600 font-medium">
        Powered by <Link href="/" className="text-gray-500 hover:text-gray-400 font-bold underline">UniPay Subscriptions</Link>
      </div>
